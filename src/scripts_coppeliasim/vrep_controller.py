            ...
            if contador < len(tiempo):
                ...
                if delta_simTime < tiempo_path:
                    ...
                    while rho > 0.06:
                        ...
                        avance.data = [pos_x+paso_x, pos_y+paso_y, 0.5]
                        avance_eu.data = [0,0,0]

                        pub_pose.publish(avance)
                        #_ = sim.simxSetObjectPosition(clientID, Quadricopter_target,-1, avance_2, sim.simx_opmode_blocking)
