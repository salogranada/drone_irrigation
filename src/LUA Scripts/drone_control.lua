--THIS CODE WORKS WELL WITH DRONE WITH THE FOLLOWING MOMENTS OF INERTIA
--X = 5.544e-02
--Y = 5.544e-02
--Z = 6.264e-00
...
function sysCall_init() 
    ...
    pPitch, iPitch, dPitch = 18,0,0.05
...
function sysCall_actuation() 
    ...
    forces_array[1] = thrust-alphaCorr+betaCorr+rotCorr
    forces_array[2] = thrust-alphaCorr-betaCorr-rotCorr
    forces_array[3] = thrust+alphaCorr-betaCorr+rotCorr
    forces_array[4] = thrust+alphaCorr+betaCorr-rotCorr
